...
EPA_K_Means_Karate_Ht_10_5S_DR=list()
EPA_K_Means_Karate_Ht_10_5S_AED=list()
...
write.csv(df,paste("./Code, Datasets and Results/Results/EPA_K-Means/",object,".csv",sep=''),sep='\t',row.names=F)
